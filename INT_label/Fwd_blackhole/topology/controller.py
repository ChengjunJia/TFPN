...
class Analyzer:
    def __init__(self, redis_db_id_list):
        ...
        for db_id in redis_db_id_list:
            r = redis.Redis(unix_socket_path=DCNconfig.redis_addr, port=DCNconfig.redis_port,db=db_id)
    ...
    def solve_bug(self):
        ...
        sendDB = redis.Redis(unix_socket_path=REDIS_ADDR,port=REDIS_PORT,db=TRACE_SEND_DB)
