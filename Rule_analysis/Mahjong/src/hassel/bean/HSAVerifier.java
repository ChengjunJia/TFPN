...
public class HSAVerifier {
	// public static ArrayList<Node> findReachabilityByPropagation(Network network,
	// Node inputPkt, ArrayList<Integer> outPorts){
	// return
	// findReachabilityByPropagation(network.getNTF(),network.getTTF(),inputPkt,outPorts);
	// }
	public static ArrayList<Node> findReachabilityByPropagation(HSATransFunc NTF, HSATransFunc TTF, Node inputPkt,
