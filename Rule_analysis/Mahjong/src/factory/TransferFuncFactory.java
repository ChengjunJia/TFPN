...
public class TransferFuncFactory {
	public static ArrayList<Node> findReachabilityByPropagation(String type, BasicTF BasicNTF, BasicTF BasicTTF,
			Node Pkt, ArrayList<Integer> Ports) {
		if (type == "HSA") {
	...
	public static ArrayList<Node> findReachabilityByPropagation(BasicTF BasicNTF, BasicTF BasicTTF, Node Pkt,
