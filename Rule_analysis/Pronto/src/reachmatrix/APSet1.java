...
public class APSet1 implements Serializable{
	...
	static int totalap;
	static HashSet<Integer> universeset;//放入所有AP
	...
	{
		universeset = unv;//static吃进all-ap
		totalap = universeset.size();//吃进all-app的size
	}
	...
	private void tocomplement()
	{
		...
		news.removeAll(apset);//apset为device的所有ap
		apset = news;
		iscomplement = !iscomplement;
	}
	
	/**
	 * change the set to its complement, note that this is
	 * different than tocomplement()
	 */
	...
	public HashSet<Integer> getApset() {
		return apset;
	}

	public void setApset(HashSet<Integer> apset) {
		this.apset = apset;
	}

	public static HashSet<Integer> getUniverseset() {
		return universeset;
	}

	public static void setUniverseset(HashSet<Integer> universeset) {
		APSet1.universeset = universeset;
	}
